<?php
$a = include CONF_PATH.'setting/setting.php';
$b = array(
    ...
    'url_convert'            => false,// 是否自动转换URL中的控制器和操作名
    ...
    'dispatch_success_tmpl'  =>ROOT_PATH.'public'.DS.'static'.DS.'error'.DS.'error.html',// 默认跳转页面对应的模板文件
    'dispatch_error_tmpl'    =>ROOT_PATH.'public'.DS.'static'.DS.'error'.DS.'error.html',
	...
	'super_admin_user_ids' => array(1),//超级管理员
	'not_auth_controller' => array('Index','System'),//无需认证的控制器
	'not_auth_action' => array('upload','getAllData','insert','update'),//无需认证的动作方法
